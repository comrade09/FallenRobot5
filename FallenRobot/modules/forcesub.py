        ...
        if (
            ...
            try:
                ...
                try:
                    ...
                    sent_message.edit(
                        f"❗ **@{BOT_USERNAME} is not admin here..**\n__Give me ban permissions and retry.. \n#Ending FSub...__"
                    )
...
def config(client, message):
    ...
    if user.status in ("administrator", "creator") or user.user.id in SUDO_USERS:
        chat_id = message.chat.id
        ...
        message.reply_text(
            "❗ **Admins Permission Required**\n__You have to be an group admin to do that.__"
        )
